...
public class PythonAIPlayerFrozen3 extends ComputerPlayer {
    ...
    public PythonAIPlayerFrozen3(String name, RangeOfInfluence range, int skill) {
        super(name, range);
        this.port = 8084;
    }

    // Overloaded programmatic constructor (For your self-play scripts)
    public PythonAIPlayerFrozen3(String name, RangeOfInfluence range, int skill, int port) {
        super(name, range);
        this.port = port;
    }

    // Copy constructor (Crucial: ensure the cloned player keeps the correct port)
    public PythonAIPlayerFrozen3(final PythonAIPlayerFrozen3 player) {
        super(player);
        this.port = player.port;
    }

    @Override
    public PythonAIPlayerFrozen3 copy() {
        return new PythonAIPlayerFrozen3(this);
    }
